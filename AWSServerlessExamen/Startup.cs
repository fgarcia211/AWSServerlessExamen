...
using AWSServerlessExamen.Helpers;
using AWSServerlessExamen.Repositories;
using Microsoft.EntityFrameworkCore;
using Microsoft.OpenApi.Models;

namespace AWSServerlessExamen;
...
public class Startup
{
    ...
    {
        string connectionString = HelperSecretManager.GetSecretAsync("MySqlExamen").Result;        
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "Api Gateway Examen MySql 2023",
                Version = "V1"
            });
        });
